...
def test_find_document_partial_match(tmp_path):
    ...
    cert_data = {"nome": "MARIO ROSSI", "matricola": "123", "categoria": "SICUREZZA", "data_scadenza": "01/01/2025"}
...
def test_find_document_deep_search(tmp_path):
    ...
    cert_data = {"nome": "MARIO ROSSI", "matricola": "999", "categoria": "FIRE", "data_scadenza": "01/01/2025"}
...
def test_find_document_prioritize_category_in_deep_search(tmp_path):
    ...
    for f in [f1, f2]:
        with open(f, "w") as out: out.write("dummy")

    cert_data = {"nome": "MARIO ROSSI", "matricola": "N-A", "categoria": "Security", "data_scadenza": None}
