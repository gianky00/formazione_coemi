...
# Env setup for API tests
os.environ["GEMINI_API_KEY"] = "test_key"
os.environ["GOOGLE_CLOUD_PROJECT"] = "test-project"
os.environ["GCS_BUCKET_NAME"] = "test-bucket"

# Conditional imports for API tests - skip if dependencies missing
# This allows desktop_app tests to run without FastAPI dependencies
...
try:
    ...
    # API modules not available - desktop_app tests can still run
    app = None
    engine = None
    Base = None
    User = None
...
# --- API-DEPENDENT FIXTURES (only active when API modules are available) ---
# These fixtures are only used by API tests, not by desktop_app tests.
