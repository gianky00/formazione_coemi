...
from app.core.string_obfuscation import _XOR_KEY, deobfuscate_string, obfuscate_string


def main():
    print("\n" + "=" * 70)
    print("🔐 KEY OBFUSCATOR - Intelleo Security Tool")
    print("=" * 70)
    print("Questo tool genera versioni offuscate di stringhe sensibili.")
    print("⚠️  NON committare l'output su repository pubblici!")
    ...
    # Input opzionali
    print("📝 Input opzionali (premi ENTER per saltare):\n")
    ...
    # Genera output
    print("\n" + "=" * 70)
    print("📋 COPY-PASTE NEL CODICE SORGENTE:")
    print("=" * 70)
    ...
    for name, secret in secrets.items():
        ...
        if recovered != secret:
            print(f"# ⚠️ WARNING: Roundtrip failed for {name}!")
            continue
    ...
    print("=" * 70)
    print("✅ Copia le righe sopra nei tuoi moduli Python")
    print("=" * 70)

    # Mostra anche formato per bytes (Fernet key)
    print("\n📝 FORMATO ALTERNATIVO PER BYTES (Fernet):")
    print("-" * 70)
