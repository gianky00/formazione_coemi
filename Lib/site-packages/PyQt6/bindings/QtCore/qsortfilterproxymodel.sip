...
%End
%If (Qt_6_10_0 -)
    typedef QFlags<QSortFilterProxyModel::Direction> Directions;
%End

protected:
%If (Qt_6_10_0 -)
    void endFilterChange(QSortFilterProxyModel::Directions directions = QSortFilterProxyModel::Direction::Both);
%End
};
