...
public:
    ...
    enum FrameFeature /BaseType=Flag/
    {
        None,
        Flat,
        Rounded,
...
class QStyleOptionHeaderV2 : public QStyleOptionHeader
{
%TypeHeaderCode
#include <qstyleoption.h>
%End
...
public:
    ...
    enum ButtonFeature /BaseType=Flag/
    {
        None,
        Flat,
        HasMenu,
...
%End
    ...
    enum CornerWidget /BaseType=Flag/
    {
        NoCornerWidgets,
        LeftCornerWidget,
        RightCornerWidget,
...
public:
    ...
    enum ViewItemFeature /BaseType=Flag/
    {
        None,
        WrapText,
        Alternate,
...
public:
    ...
    enum ToolButtonFeature /BaseType=Flag/
    {
        None,
        Arrow,
        Menu,
...
public:
    ...
    enum ToolBarFeature /BaseType=Flag/
    {
        None,
        Movable,
    };
