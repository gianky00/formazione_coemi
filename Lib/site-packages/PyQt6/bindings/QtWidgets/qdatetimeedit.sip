...
public:
    ...
    QDateTimeEdit(QDate d, QWidget *parent /TransferThis/ = 0);
    QDateTimeEdit(QTime t, QWidget *parent /TransferThis/ = 0);
...
public:
    ...
    QTimeEdit(QTime time, QWidget *parent /TransferThis/ = 0);
    virtual ~QTimeEdit();
};
...
public:
    ...
    QDateEdit(QDate date, QWidget *parent /TransferThis/ = 0);
    virtual ~QDateEdit();
};
